...
\multicolumn{1}{l|}{{\color[HTML]{000000} }} & \multicolumn{1}{c||} {\cellcolor[HTML]{EFEFEF} Preu (\euro)} & {\cellcolor[HTML]{EFEFEF} 983231.2} & {\cellcolor[HTML]{EFEFEF} 1007763} & {\cellcolor[HTML]{EFEFEF} 1034778.8} & {\cellcolor[HTML]{EFEFEF} 1390977.2} \\ 
\multicolumn{1}{l|}{\multirow{-6}{*}{{\color[HTML]{000000} \begin{tabular}[c]{@{}l@{}}Dual-Socket\\ AMD-7502\end{tabular}}}} & \multicolumn{1}{c||} {\color[HTML]{000000} Gflops/\euro} & {\color[HTML]{000000} 0.282} & {\color[HTML]{000000} 0.262} & {\color[HTML]{000000} 0.275} & {\color[HTML]{000000} 0.200} \\ \hline
\end{tabular}
