...
\multicolumn{1}{|c|}{{\color[HTML]{000000} }} & \multicolumn{1}{l||} {\cellcolor[HTML]{EFEFEF} nodes 1U} & {\cellcolor[HTML]{EFEFEF} 72} & {\cellcolor[HTML]{EFEFEF} 71} & {\cellcolor[HTML]{EFEFEF} 75} & {\cellcolor[HTML]{EFEFEF} 75} \\ 
\multicolumn{1}{|c|}{{\color[HTML]{000000} }} & \multicolumn{1}{c||}{\color[HTML]{000000} nodes 2U} & {\color[HTML]{000000} 3} & {\color[HTML]{000000} 3} & {\color[HTML]{000000} 3} & {\color[HTML]{000000} 3} \\ 
\multicolumn{1}{|c|}{{\color[HTML]{000000}} } & \multicolumn{1}{c||} {\cellcolor[HTML]{EFEFEF} Gràfiques} & {\cellcolor[HTML]{EFEFEF}} \begin{tabular}[c]{@{}l@{}}NVIDIA \\ tesla V100\end{tabular} & {\cellcolor[HTML]{EFEFEF} \begin{tabular}[c]{@{}l@{}}AMD Radeon\\ Instinct MI50\end{tabular}} & {\cellcolor[HTML]{EFEFEF} \begin{tabular}[c]{@{}l@{}}NVIDIA\\ tesla V100\end{tabular}} & {\cellcolor[HTML]{EFEFEF} \begin{tabular}[c]{@{}l@{}}NVIDIA\\ tesla V100\end{tabular}} \\
\multicolumn{1}{|c|}{{\color[HTML]{000000} }} & \multicolumn{1}{c||}{\color[HTML]{000000} TFlops} & {\color[HTML]{000000} 213.594} & {\color[HTML]{000000} 208.345} & {\color[HTML]{000000} 219.594} & {\color[HTML]{000000} 219.594} \\
...
\multicolumn{1}{|c|}{\multirow{-6}{*}{{\color[HTML]{000000} \begin{tabular}[c]{@{}c@{}}Single-Socket\\ AMD 7702\end{tabular}}}} & \multicolumn{1}{c||}{\color[HTML]{000000} Gflops/\euro} & {\color[HTML]{000000} 0.258} & {\color[HTML]{000000} 0.258} & {\color[HTML]{000000} 0.252} & {\color[HTML]{000000} 0.231} \\ \hline
\multicolumn{1}{|l|}{{\cellcolor[HTML]{FFFFFF} }} & \multicolumn{1}{c||} {\cellcolor[HTML]{EFEFEF} nodes 1U} & {\cellcolor[HTML]{EFEFEF} 74} & {\cellcolor[HTML]{EFEFEF} 73} & {\cellcolor[HTML]{EFEFEF} 77} & {\cellcolor[HTML]{EFEFEF} 77} \\ 
\multicolumn{1}{|l|}{{\color[HTML]{000000} }} & \multicolumn{1}{c||}{\color[HTML]{000000} nodes 2U} & {\color[HTML]{000000} 2} & {\color[HTML]{000000} 2} & {\color[HTML]{000000} 2} & {\color[HTML]{000000} 2} \\ 
